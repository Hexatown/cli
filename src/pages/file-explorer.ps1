...
try
{
$rss = & "$PSScriptRoot\..\helpers\powerbrickrss.ps1"
$rssFeed = $rss[0]
$rssData = $rss[1]
}
...
function onRssSelected ($object,$event){
 # write-host "select"  $object $event
Start $rssList.selectedValue.webUrl
			...
			<TabItem Header="Tab 0" Visibility="Collapsed" Name="Tab0">
				...
				<Grid>
					...
					<StackPanel Grid.Row="1">
						...
						<ListView ItemsSource="{Binding data2}" Name="rssList" SelectionMode="Single">
							<ListView.ItemTemplate>
								<DataTemplate>
									<StackPanel Orientation="Horizontal" Height="35" >

										<StackPanel Orientation="Vertical" VerticalAlignment="Center" Margin="12,0,0,0" Name="Item2">
											<TextBlock Text="{Binding displayName}" FontWeight="Semibold" FontSize="22" />
...
$sharepointSitesList.Add_MouseDoubleClick({onOK $this $_})

$rssList.Add_MouseDoubleClick({onRssSelected $this $_})
...
Set-Binding -Target $rssList -Property $([System.Windows.Controls.ListView]::ItemsSourceProperty) -Index 1 -Name "data2"
